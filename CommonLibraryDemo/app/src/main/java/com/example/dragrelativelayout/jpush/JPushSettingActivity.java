package com.example.dragrelativelayout.jpush;
...
public class JPushSettingActivity extends InstrumentedActivity implements OnClickListener {
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.jpush_set_time);
		init();
		initListener();
	}
