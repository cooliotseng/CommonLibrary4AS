package com.example.dragrelativelayout.sharesdk;
...
import com.commonlibrary.sharesdk.ShareData;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.email_view:
                ...
                mData.mPlatformType = ShareManager.PlatofrmType.Email;
            ...
            case R.id.sms_view:
                ...
                mData.mPlatformType = ShareManager.PlatofrmType.SMS;
            ...
            case R.id.tecent_weibo_view:
                ...
                mData.mPlatformType = ShareManager.PlatofrmType.TencentWeibo;
